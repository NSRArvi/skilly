...
export default function ProfessionalDetailsPage() {
    ...
    return (
      <div className="min-h-screen bg-background pb-24 animate-pulse">
        ...
        <Container className="relative">
          <div className="bg-card border border-border rounded-xl shadow-xl -mt-20 p-8 md:p-12 mb-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-card border border-border rounded-xl p-8 h-48 bg-muted/30"></div>
              <div className="bg-card border border-border rounded-xl p-8 h-64 bg-muted/30"></div>
            </div>
            <div className="space-y-8">
              <div className="bg-card border border-border rounded-xl p-8 h-40 bg-muted/30"></div>
              <div className="bg-card border border-border rounded-xl p-8 h-40 bg-muted/30"></div>
            </div>
          </div>
        </Container>
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <Container className="relative">
        <div className="bg-card border border-border rounded-xl -mt-20 p-8 md:p-12 mb-8 relative z-10">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            {/* Avatar */}
                ...
                <div className="text-left md:text-right">
                  ...
                  <div className="flex items-center md:justify-end gap-4 mt-4 text-muted-foreground relative z-20">
                    ...
                    {profile.social_facebook && (
                      <a
                        href={getValidUrl(profile.social_facebook)}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hover:text-primary transition-colors cursor-pointer"
                      >
              ...
              {profile.skills_for && profile.skills_for.length > 0 && (
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {profile.skills_for.map((skill, index) => (
                      <span
                        key={index}
                        className="px-4 py-2 bg-secondary/10 text-secondary-foreground border border-secondary/20 rounded-xl text-sm font-medium"
                      >
                        {skill}
                      </span>
                    ))}
